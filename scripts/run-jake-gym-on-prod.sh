#!/bin/bash
# Run get-jake-gym-membership.js on production as one-off ECS task
set -e
...
CMD="node /app/scripts/get-jake-gym-membership.js"
...
echo "Starting one-off task to fetch Jake's gym membership..."
