...
const { getContractStartEndYmdFromSucceededPaymentIntent, computeGymContractEndYmdFromStartYmd } = require('./gym-contract-dates');
...
async function reanchorGymContractForEmail(stripe, db, email, options = {}) {
  ...
  let contractEndYmd = manualStartYmd ? computeGymContractEndYmdFromStartYmd(manualStartYmd) : null;
